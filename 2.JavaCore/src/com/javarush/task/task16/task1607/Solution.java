...
/* Задача 1607 - нет в задаче ничего особополезного - она мне просто нравится :)
* четко видно как лошадки запускаются, бегут, финишируют
* (когда интернет отрубят можно будет тотализатор организовать :) )
*
Horse Racing
*/
