...
/* Задача 1612 - каждую нити можно запрограмировать на свою скорость выполнения
* это полезно если у процессов есть общие методы
* и известно какой их них должен быть быстрее
