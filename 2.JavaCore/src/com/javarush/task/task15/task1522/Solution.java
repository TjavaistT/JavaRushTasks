...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        //три кита простого синглтона:
        //  - не давать никому наследовать класс,
        //  - не давать никому создавать объект (только самостоятельно),
        //  - не давать никому создавать второй объект
        //  короче патерн который "не дает" :)
        initPlanet(key);
    }
